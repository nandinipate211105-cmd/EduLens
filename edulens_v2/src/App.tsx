...
export default function App() {
  ...
  const renderContent = () => {
    ...
    if (isTeacher) {
      switch (activeTab) {
        case 'dashboard':    return <TeacherDashboard key="t-dashboard" user={user} />;
        ...
        case 'attendance':   return <AttendanceTab key="attendance" user={user} isTeacher />;
        ...
        default:             return <TeacherDashboard key="t-dashboard-d" user={user} />;
      }
    } else {
      switch (activeTab) {
        case 'dashboard':      return <StudentDashboard key="s-dashboard" user={user} />;
        case 'my-performance': return <MyPerformance key="perf" />;
        case 'learning-gaps':  return <LearningGaps key="gaps" user={user} isTeacher={false} />;
        case 'attendance':     return <AttendanceTab key="s-attendance" user={user} isTeacher={false} />;
        ...
        default:               return <StudentDashboard key="s-dashboard-d" user={user} />;
      }
    }
  };
