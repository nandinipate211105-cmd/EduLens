...
export default function Sidebar({ user, activeTab, setActiveTab, onLogout }: SidebarProps) {
  ...
  const portalSubtitle =
    user.role === 'admin' ? 'Admin Portal' : isTeacher ? 'Teacher Portal' : 'Student Portal';
      ...
      <div className="mt-auto border-t border-white/10 pt-4">
        <div className="mb-3 flex items-center gap-3 px-4 py-2">
          ...
          <div className="overflow-hidden">
            <p className="truncate font-syne text-sm font-bold text-white">{user.displayName || user.email || 'User'}</p>
